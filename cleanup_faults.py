...
fault_individuals = [
    ...
    'AlignmentFailure_001', 'MountFailure_001', 'StructuralFailure_001', 'VibrationFailure_001'
]
...
while i < len(lines):
    ...
    if is_fault:
        ...
        skip_until_end = True
    elif skip_until_end and '</owl:NamedIndividual>' in line:
        skip_until_end = False
        i += 1
...
print(f"Removed {count} fault individuals from ontology")
